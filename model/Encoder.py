...
class LICRFEncoder(nn.Module):
    def __init__(self, model_info):
        super(LICRFEncoder, self).__init__()
        color_channel = model_info['color_channel']
        n_feats_list = model_info['n_feats_list']
        n_block_list = model_info['n_block_list']
        num_heads_list = model_info['num_heads_list']
        ...
        for i in range(n_stage):
            ...
            group_layer =LICRFGroup(n_feats_list[i],n_block_list[i],num_heads_list[i],window_size_list[i],
            input_resolution=(input_resolution[0]//(2**(i+1)),input_resolution[1]//(2**(i+1))))
            self.group_layers.append(group_layer)
...
class FAPGBEncoder(nn.Module):
    def __init__(self, model_info):
        super(FAPGBEncoder, self).__init__()
        color_channel = model_info['color_channel']
        n_feats_list = model_info['n_feats_list']
        n_block_list = model_info['n_block_list']
        window_size_list = model_info['window_size_list']
        ...
        for i in range(n_stage):
            ...
            group_layer = FAPGBGroup(n_feats_list[i],n_block_list[i],window_size_list[i],ratio)
            self.group_layers.append(group_layer)
...
class FAEncoderwoAT(nn.Module):
    def __init__(self, model_info):
        super(FAEncoderwoAT, self).__init__()
        color_channel = model_info['color_channel']
        n_feats_list = model_info['n_feats_list']
        n_block_list = model_info['n_block_list']
        window_size_list = model_info['window_size_list']
        ...
        for i in range(n_stage):
            ...
            group_layer = FAGroupwoAT(n_feats_list[i],n_block_list[i],window_size_list[i],ratio)
            self.group_layers.append(group_layer)
...
class FAEncoderwoLA(nn.Module):
    def __init__(self, model_info):
        super(FAEncoderwoLA, self).__init__()
        color_channel = model_info['color_channel']
        n_feats_list = model_info['n_feats_list']
        n_block_list = model_info['n_block_list']
        window_size_list = model_info['window_size_list']
        ...
        for i in range(n_stage):
            ...
            group_layer = FAGroupwoLA(n_feats_list[i],n_block_list[i],window_size_list[i],ratio)
            self.group_layers.append(group_layer)
...
class FAEncoderwoDf(nn.Module):
    def __init__(self, model_info):
        super(FAEncoderwoDf, self).__init__()
        color_channel = model_info['color_channel']
        n_feats_list = model_info['n_feats_list']
        n_block_list = model_info['n_block_list']
        window_size_list = model_info['window_size_list']
        ...
        for i in range(n_stage):
            ...
            group_layer = FAGroupwoDf(n_feats_list[i],n_block_list[i],window_size_list[i],ratio)
            self.group_layers.append(group_layer)
...
class LAEncoder(nn.Module):
    def __init__(self, model_info):
        super(LAEncoder, self).__init__()
        color_channel = model_info['color_channel']
        n_feats_list = model_info['n_feats_list']
        n_block_list = model_info['n_block_list']
        window_size_list = model_info['window_size_list']
        ...
        for i in range(n_stage):
            ...
            group_layer = LAGroup(n_feats_list[i],n_block_list[i],window_size_list[i])
            self.group_layers.append(group_layer)
