...
#Basic layer is modified for simplicity and generalization
#[1] K. Yang, S. Wang, J. Dai, X. Qin, K. Niu, and P. Zhang, ��SwinJSCC: Taming swin transformer for deep joint source-channel coding,�� 
...
class SWGroup(nn.Module):
    def __init__(self, n_feats, n_block, num_heads, window_size, input_resolution=(128,128),
        ...
        self.blocks = nn.ModuleList([
            SwinTransformerBlock(dim=n_feats,
